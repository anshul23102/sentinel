  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 48px 120px rgba(0,0,0,0.8), 0 0 0 1px rgba(139,92,246,0.1)',
      }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
                ...
                <div>
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, #ffffff 30%, #c4b5fd 70%, #67e8f9 100%)',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10, marginBottom: 28 }}>
                {STATS.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.3)', marginTop: 4, fontWeight: 500 }}>{s.label}</div>
                  </div>
                ))}
              </div>
          ...
          <>
            ...
            <div style={{ padding: '30px 40px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 22 }}>
                <div style={{ fontSize: 16, fontWeight: 800, color: 'white' }}>What's inside</div>
                <button onClick={() => setPage(0)} style={{
                  marginLeft: 'auto', fontSize: 12, color: 'rgba(255,255,255,0.4)', background: 'none',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
                {FEATURES.map((f, i) => (
                  <div key={i} style={{
                    ...
                    <div>
                      <div style={{ fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,0.88)', marginBottom: 3 }}>{f.title}</div>
              ...
              <div style={{
                ...
                background: 'rgba(124,58,237,0.07)', border: '1px solid rgba(139,92,246,0.2)',
                fontSize: 12, color: '#c4b5fd', lineHeight: 1.6, marginBottom: 20,
              }}>
        ...
        {/* Bottom hint */}
        <div style={{
          padding: '10px 40px 16px', borderTop: '1px solid rgba(255,255,255,0.05)',
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
          fontSize: 10, color: 'rgba(255,255,255,0.18)',
        }}>
          <span>Press</span>
          <span style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 4, padding: '1px 6px', fontFamily: 'monospace' }}>Esc</span>
